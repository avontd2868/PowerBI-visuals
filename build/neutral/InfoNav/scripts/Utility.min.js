...
!function(a) {
    var b = function() {
        ...
        return b.prototype.showMessage = function(b, c) {
        ...
        }, b.prototype.showCustomDialog = function(a, b, c, d, e, f, g) {
            g && (this._modalDialogElement.addClass(g), this._modalDialogCustomClass = g);
            for (var h = [], i = 0; i < c.length; i++) {
                var j = c[i], k = j.cssClass;
                0 === i && (k += " primary"), h[i] = this.createButton(j.labelText, j.actionCallback, j.data, k, j.disabled);
            }
            return this.pushMessage(a, null, b, h, e, d, f), this._dialogContent;
            ...
            this._modalContainer.fadeTo(b.AnimationSpeedMs, 0, function() {
                ...
                c._modalDialogElement.removeClass(c._modalDialogCustomClass), c._messageCurrentlyShown = !1, 
...
!function(a) {
    function b(a) {
        ...
        try {
            ...
            b = error.stack, null != b && (c = b.split("\n"), c.splice(1, a), b = c.join("\n"));
        }
        return b;
    }
    var c;
    ...
    !function(b) {
        function d(b) {
            if (b) try {
                ...
                var f = "Error while uncompressing TileData: {0}";
                a.Trace.error(c.format(f, JSON.stringify(e)), null != e.stack ? !1 : !0);
            }
            return null;
        }
        function e(b) {
            if (b) try {
                ...
                return a.Trace.error(c.format("Error while compressing TileData: {0}", JSON.stringify(e)), null != e.stack ? !1 : !0), 
                null;
            }
            return null;
        }
