    ...
    !function(a) {
        ...
        !function(b) {
            function c(b, c, d) {
                var e = [], g = f(b, d);
                if (!g) return e;
                var h = g.type, i = g.kind, j = g.idOnEntityKey;
                a.QueryAggregateFunction;
                return h ? 1 === i ? e : c ? e : h.numeric || h.integer ? 1 === g.defaultAggregate ? [ 2, 5 ] : [ 0, 1, 3, 4, 2, 5 ] : h.text || h.bool || h.dateTime ? j ? [ 5 ] : [ 2, 5 ] : e : e;
            }
            function d(b, c) {
            ...
            b.getSupportedAggregates = c, b.indexOfExpr = d, b.sequenceEqual = e;
    ...
    !function(b) {
        ...
        !function(c) {
            ...
            function e(c, d) {
                ...
                var e = d.values ? d.values.grouped()[0].values : [], h = d.categories[0], i = h.values, j = h.identity, k = j.length, l = [], m = f(k);
                c.columns.push(h.source);
                for (var n = 0; k > n; n++) for (var o = j[n], p = i[n], q = 0, r = e.length; r > q; q++) {
    ...
    !function(b) {
        ...
        var C = (b.SQExprValidationError, function(a) {
            ...
            return __extends(c, a), c.prototype.visitColumnRef = function(a) {
                ...
                var d = b.SQExprUtils.getSupportedAggregates(c, !1, this.schema);
                d.indexOf(c.func) < 0 && this.register(0);
                var e = a.prototype.visitAggr.call(this, c);
                return e;
            }, c.prototype.visitEntity = function(a) {
    ...
    !function(a) {
        var b = jsCommon.ArrayExtensions, c = jsCommon.StringExtensions, d = function() {
            ...
            return d.create = function() {
                return d.empty || (d.empty = new d(new f(), null, null, [])), d.empty;
            }, d.createWithTrimmedFrom = function(a, b, c, e) {
                var f = new i(a.keys());
                ...
                if (c) for (var g = 0, h = c.length; h > g; g++) c[g].expr.accept(f);
            ...
            }, d.prototype.getSelect = function() {
            ...
            }, d.prototype.setSelect = function(a) {
                for (var b = [], c = this.fromValue.clone(), e = 0, f = a.length; f > e; e++) {
                    var h = a[e];
                    b.push({
                        name: h.name,
                        expr: g.rewrite(h.expr, c)
                    });
                }
                return d.createWithTrimmedFrom(c, this.whereItems, this.orderByItems, b);
            }, d.prototype.removeSelect = function(b) {
                for (var c = this.selectItems, e = [], f = 0, g = c.length; g > f; f++) {
                    var h = c[f];
                    a.SQExpr.equals(h.expr, b) || e.push(h);
                }
                return d.createWithTrimmedFrom(this.fromValue.clone(), this.whereItems, this.orderByItems, e);
            }, d.prototype.removeOrderBy = function(b) {
                for (var c = this.orderBy(), e = c.length - 1; e >= 0; e--) a.SQExpr.equals(c[e].expr, b) && c.splice(e, 1);
                return d.createWithTrimmedFrom(this.fromValue.clone(), this.whereItems, c, this.selectItems);
            }, d.prototype.selectNameOf = function(b) {
                var c = a.SQExprUtils.indexOfExpr(this.selectItems.map(function(a) {
                    return a.expr;
                }), b);
                return c >= 0 ? this.selectItems[c].name : void 0;
            }, d.prototype.setSelectAt = function(a, b) {
                if (!(a >= this.selectItems.length)) {
                    var c = this.select(), e = this.fromValue.clone(), f = c[a].name;
                    return c[a] = {
                        name: f,
                        expr: g.rewrite(b, e)
                    }, d.createWithTrimmedFrom(e, this.whereItems, this.orderByItems, c);
                }
            }, d.prototype.addSelect = function(a) {
                var b = this.select(), c = this.fromValue.clone();
                return b.push({
                    name: this.getUniqueExprName(b),
                    expr: g.rewrite(a, c)
                }), d.createWithTrimmedFrom(c, this.whereItems, this.orderByItems, b);
            }, d.prototype.orderBy = function(a) {
                return 0 === arguments.length ? this.getOrderBy() : this.setOrderBy(a);
            }, d.prototype.getOrderBy = function() {
                ...
                return a;
            }, d.prototype.setOrderBy = function(a) {
                for (var b = [], c = this.fromValue.clone(), e = 0, f = a.length; f > e; e++) {
                    var h = a[e];
                    b.push({
                        expr: g.rewrite(h.expr, c),
                ...
                return d.createWithTrimmedFrom(c, this.whereItems, b, this.selectItems);
            }, d.prototype.where = function(a) {
                return 0 === arguments.length ? this.getWhere() : this.setWhere(a);
            }, d.prototype.getWhere = function() {
                var a = [], b = this.whereItems;
                if (b) for (var c = 0, d = b.length; d > c; c++) a.push(b[c]);
                return a;
            }, d.prototype.setWhere = function(a) {
                for (var b = [], c = this.fromValue.clone(), e = 0, f = a.length; f > e; e++) {
                    var h = a[e], i = {
                        condition: g.rewrite(h.condition, c)
                    }, j = h.target;
                    if (j) {
                        i.target = [];
                        for (var k = 0, l = j.length; l > k; k++) if (j[k]) {
                            var m = g.rewrite(j[k], c);
                            i.target.push(m);
                        }
                    }
                    b.push(i);
                }
                return d.createWithTrimmedFrom(c, b, this.orderByItems, this.selectItems);
            }, d.prototype.addWhere = function(a) {
                for (var b = this.where(), c = a.where(), e = this.fromValue.clone(), f = 0, h = c.length; h > f; f++) {
                    var i = c[f], j = {
                        condition: g.rewrite(i.condition, e)
                    };
                    i.target && (j.target = i.target.map(function(a) {
                        return g.rewrite(a, e);
                    })), b.push(j);
                }
                return d.createWithTrimmedFrom(e, b, this.orderByItems, this.selectItems);
            }, d.prototype.rewrite = function(b) {
                var c = new a.SemanticQueryRewriter(b), e = c.rewriteFrom(this.fromValue), f = c.rewriteWhere(this.whereItems, e), g = c.rewriteOrderBy(this.orderByItems, e), h = c.rewriteSelect(this.selectItems, e);
                return d.createWithTrimmedFrom(e, f, g, h);
            }, d.prototype.getUniqueExprName = function(a) {
        ...
        var e = function() {
            ...
            return c.fromSQExpr = function(a) {
                ...
                for (var d = a.whereItems, e = 0; e < d.length; e++) {
                    var f = d[e], h = {
                        condition: g.rewrite(f.condition, b)
                    };
                    f.target && (h.target = f.target.map(function(a) {
                        return g.rewrite(a, b);
                    })), c.push(h);
                }
            }, c;
        }();
        ...
        var g = function(c) {
            ...
            return __extends(d, c), d.prototype.visitEntity = function(b) {
                ...
                var c = h.run(a, b), e = new d(c);
                return a.accept(e);
            }, d;
        }(a.SQExprRewriter);
        a.SQExprRewriterWithSourceRenames = g;
        var h = function(a) {
            function b(b) {
        ...
        }(a.DefaultSQExprVisitorWithTraversal), i = function(a) {
            function b(b) {
