...
(function (jsCommon) {
    ...
    var ModalDialog = (function () {
         ...
         */
        ModalDialog.prototype.showCustomDialog = function (titleText, dialogContent, dialogActions, onDialogDisplayed, isDismissable, focusOnFirstButton) {
            var actionsButtons = [];
...
(function (powerbi) {
    ...
    (function (telemetry) {
        ...
        telemetry.BaseEvent = function (parentId, isError) {
        ...
        telemetry.Trace = function (type, message) {
            var info = {
                type: type,
                message: message,
            };
        ...
        telemetry.Error = function (message) {
            var info = {
                message: message,
            };
            var event = {
        ...
        telemetry.ErrorWithStackTrace = function (stack, message) {
            var info = {
                stack: stack,
                message: message,
            };
        ...
        telemetry.ErrorWithStackTraceAndSourceDetails = function (source, lineNumber, columnNumber, stack, message) {
            var info = {
                source: source,
        ...
        telemetry.CustomerAction = function (parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                parentId: parentId,
                isError: isError,
        ...
        telemetry.Verbose = function (parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                parentId: parentId,
                isError: isError,
        ...
        telemetry.DashboardRootSession = function (parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                parentId: parentId,
                isError: isError,
        ...
        telemetry.WFEInvitationSignUp = function (parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                parentId: parentId,
                isError: isError,
        ...
        telemetry.WFEError = function (errorCode, errorType, parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                errorCode: errorCode,
                errorType: errorType,
        ...
        telemetry.DashboardErrorDialog = function (raid, caid, errorType, message) {
            var info = {
                raid: raid,
                caid: caid,
                errorType: errorType,
        ...
        telemetry.MobileLandingContinuedToWeb = function (parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                parentId: parentId,
                isError: isError,
        ...
        telemetry.MobileLandingDownloadApp = function (parentId, isError) {
            if (isError === void 0) { isError = false; }
            var info = {
                parentId: parentId,
                isError: isError,
        ...
        telemetry.DashboardUnhandledAngularException = function (stack, message) {
            var info = {
                stack: stack,
                message: message,
            };
        ...
        telemetry.DashboardUnhandledException = function (source, lineNumber, columnNumber, stack, message) {
            var info = {
                source: source,
                lineNumber: lineNumber,
                columnNumber: columnNumber,
...
(function (powerbi) {
    ...
    })(powerbi.TelemetryCategory || (powerbi.TelemetryCategory = {}));
    var TelemetryCategory = powerbi.TelemetryCategory;
    (function (LoggerServiceType) {
        LoggerServiceType[LoggerServiceType["Localytics"] = 0x1] = "Localytics";
        LoggerServiceType[LoggerServiceType["AppInsightDeprecated"] = 0x2] = "AppInsightDeprecated";
        LoggerServiceType[LoggerServiceType["AppInsight"] = 0x4] = "AppInsight";
        LoggerServiceType[LoggerServiceType["Etw"] = 0x8] = "Etw";
        LoggerServiceType[LoggerServiceType["Mobile"] = 0x10] = "Mobile";
        LoggerServiceType[LoggerServiceType["WinJs"] = 0x20] = "WinJs";
        LoggerServiceType[LoggerServiceType["Designer"] = 0x40] = "Designer";
    })(powerbi.LoggerServiceType || (powerbi.LoggerServiceType = {}));
    var LoggerServiceType = powerbi.LoggerServiceType;
})(powerbi || (powerbi = {}));
//-----------------------------------------------------------------------
// <copyright company="Microsoft Corporation">
//        Copyright (c) Microsoft Corporation.  All rights reserved.
...
var powerbi;
(function (powerbi) {
    function createTelemetryService(hostService) {
    ...
    var TelemetryService = (function () {
        function TelemetryService(telemetryHost) {
        ...
        TelemetryService.prototype.startSession = function () {
            ...
            this._rootEvent = powerbi.telemetry.DashboardRootSession('', false);
        ...
        TelemetryService.prototype.startSessionTimeout = function () {
            ...
            this.sessionExpirationTimerId = window.setTimeout(function () {
                // reset session id
                _this.hostData.sessionId = jsCommon.Utility.generateGuid();
                _this.startSession();
        ...
        TelemetryService.prototype.removeEvent = function (eventId) {
        ...
        TelemetryService.prototype.removeScopeEvent = function (scopeId) {
            for (var i = 0, len = this.perfEvents.length; i < len; i++) {
        ...
        TelemetryService.prototype.resolveParent = function (parentEventId) {
            for (var i = 0, len = this.perfEvents.length; i < len; i++) {
        ...
        TelemetryService.prototype.forceResolve = function (scopeId) {
            for (var i = 0, len = this.perfEvents.length; i < len; i++) {
                if (this.perfEvents[i].scopeId === scopeId) {
        ...
        TelemetryService.prototype.startPerfEvent = function (scope, eventFactory) {
            var _this = this;
            var args = [];
            ...
            tempEvent = new DeferredTelemetryEvent(event, function (e) {
                ...
                if (event.id) {
                    if (!_this.removeEvent(event.id))
                        return;
                }
                else {
                    if (!_this.removeScopeEvent(scope.$id))
                        return;
                }
                // End the timed telemetry event
                if (eventFactory)
                    _this.endTimedEventInternal(e);
                // If there is a parent event, remove this event as a dependency
                if (parentEventId)
                    _this.resolveParent(parentEventId);
                if (eventTimeout)
        ...
        TelemetryService.prototype.startEvent = function (eventFactory) {
            ...
            var event = eventFactory.apply(null, args);
            this.startTimedEventInternal(event);
            return new DeferredTelemetryEvent(event, function (e) { return _this.endTimedEventInternal(e); });
        };
        ...
        TelemetryService.prototype.logEventDeprecated = function (event) {
            this.logEventInternal(event);
        };
        ...
        TelemetryService.SessionTimeout = 30 * 60 * 1000;
    ...
    var DeferredTelemetryEvent = (function () {
        ...
        DeferredTelemetryEvent.prototype.reject = function () {
...
var powerbi;
(function (powerbi) {
    var AppInsightsV2Service = (function () {
        function AppInsightsV2Service(appInsightsV2Service) {
            this.hostData = null;
            this.appInsightsV2Service = appInsightsV2Service;
            this.appInsightsV2Service.trackPageView();
        }
        AppInsightsV2Service.prototype.initialize = function (hostData) {
        ...
        AppInsightsV2Service.prototype.startTimedEvent = function (eventData) {
        };
        /** Log a timed event **/
        AppInsightsV2Service.prototype.endTimedEvent = function (eventData) {
            var properties = $.extend({}, this.hostData, eventData.getFormattedInfoObject(), {
                id: eventData.id,
                start: (new Date(eventData.time)).toISOString(),
        ...
        return AppInsightsV2Service;
    })();
    powerbi.AppInsightsV2Service = AppInsightsV2Service;
    ...
    powerbi.loadAppInsightsV2 = loadAppInsightsV2;
    loadAppInsightsV2();
})(powerbi || (powerbi = {}));
//-----------------------------------------------------------------------
// <copyright company="Microsoft Corporation">
...
(function (powerbi) {
    (function (Status) {
        ...
        Status[Status["CanBeClosed"] = 1] = "CanBeClosed";
    })(powerbi.Status || (powerbi.Status = {}));
    var Status = powerbi.Status;
    /* Wrapper used by the perf team. Keeps track of when child events are closed. */
    var AutoEndingWrapper = (function () {
        function AutoEndingWrapper(loggerService) {
            this.eventsInStorage = [];
            this.loggerService = loggerService;
        }
        AutoEndingWrapper.prototype.initialize = function (hostData) {
            this.loggerService.initialize(hostData);
        };
        AutoEndingWrapper.prototype.getType = function () {
            return this.loggerService.getType();
        };
        /** Log telemetry event **/
        AutoEndingWrapper.prototype.logEvent = function (eventData) {
            // Don't worry about hanging onto calls to log
            this.loggerService.logEvent(eventData);
        };
        /** Starts receording a timed event **/
        AutoEndingWrapper.prototype.startTimedEvent = function (eventData) {
        ...
        /** Log a timed event **/
        AutoEndingWrapper.prototype.endTimedEvent = function (eventData) {
            var _this = this;
            ...
            if (children.length === 0) {
                ...
                while (currentEvent) {
                    ...
                    var parents = this.eventsInStorage.filter(function (event) {
                        return currentEvent.info.parentId && event.eventData.id === currentEvent.info.parentId && event.status === 1 /* CanBeClosed */ && _this.getChildren(event.eventData.id).length === 0;
                    });
                    if (parents.length > 0) {
                ...
                this.eventsInStorage.push({
                    eventData: eventData,
                    status: 1 /* CanBeClosed */
                });
            }
        };
        AutoEndingWrapper.prototype.getChildren = function (id) {
            return this.eventsInStorage.filter(function (event) {
                return event.eventData.info.parentId !== undefined && event.eventData.info.parentId === id;
            });
        };
        AutoEndingWrapper.prototype.removeEventsWithId = function (id) {
            for (var i = this.eventsInStorage.length - 1; i >= 0; i--) {
                var eventToRemove = this.eventsInStorage[i].eventData;
                if (eventToRemove.id === id) {
                    this.eventsInStorage.splice(i, 1);
                }
            }
        };
        return AutoEndingWrapper;
    })();
    powerbi.AutoEndingWrapper = AutoEndingWrapper;
})(powerbi || (powerbi = {}));
//-----------------------------------------------------------------------
// <copyright company="Microsoft Corporation">
//        Copyright (c) Microsoft Corporation.  All rights reserved.
...
var powerbi;
(function (powerbi) {
    var EtwPerfLoggerService = (function () {
        function EtwPerfLoggerService() {
        }
        EtwPerfLoggerService.prototype.initialize = function (hostData) {
            this.hostData = hostData;
        };
        EtwPerfLoggerService.prototype.getType = function () {
            return 8 /* Etw */;
        };
        /** Log telemetry event **/
        EtwPerfLoggerService.prototype.logEvent = function (eventData) {
        };
        /** Starts receording a timed event **/
        EtwPerfLoggerService.prototype.startTimedEvent = function (eventData) {
            ...
            if (this.isProfilerAvailable()) {
                var eventToLog = eventData;
                var parentId = eventToLog.info.parentId ? eventToLog.info.parentId : '';
                var message = eventData.name + "_A:" + eventData.id + "_P:" + parentId + "_C:" + this.hostData.sessionId + ":Begin";
                window.msWriteProfilerMark(message);
            }
        };
        /** Log a timed event **/
        EtwPerfLoggerService.prototype.endTimedEvent = function (eventData) {
            if (this.isProfilerAvailable()) {
                var eventToLog = eventData;
                var parentId = eventToLog.info.parentId ? eventToLog.info.parentId : '';
                var message = eventData.name + "_A:" + eventData.id + "_P:" + parentId + "_C:" + this.hostData.sessionId + ":End";
                window.msWriteProfilerMark(message);
            }
        };
        EtwPerfLoggerService.prototype.isProfilerAvailable = function () {
            return window.msWriteProfilerMark != null;
        };
        return EtwPerfLoggerService;
    })();
    powerbi.EtwPerfLoggerService = EtwPerfLoggerService;
})(powerbi || (powerbi = {}));
//-----------------------------------------------------------------------
// <copyright company="Microsoft Corporation">
//        Copyright (c) Microsoft Corporation.  All rights reserved.
...
(function (powerbi) {
    var DefaultTimer = (function () {
        ...
        DefaultTimer.prototype.setTimeout = function (callback, period, arg) {
            return setTimeout(callback, period, arg);
        };
        DefaultTimer.prototype.setInterval = function (callback, period, arg) {
            return setInterval(callback, period, arg);
        };
        DefaultTimer.prototype.clearTimeout = function (id) {
            clearTimeout(id);
        };
        DefaultTimer.prototype.clearInterval = function (id) {
            clearInterval(id);
        };
        return DefaultTimer;
    })();
    powerbi.DefaultTimer = DefaultTimer;
    var IdleCallbackTimer = (function () {
        function IdleCallbackTimer(pollingDelay, callbackDelay, timer) {
            this.callbacks = [];
            this.isIdle = false;
            var self = this;
        ...
        IdleCallbackTimer.prototype.somethingJustHappenedCallback = function (event) {
            event.data.somethingJustHappened(event.data);
        };
        IdleCallbackTimer.prototype.somethingJustHappened = function (self) {
        ...
        IdleCallbackTimer.prototype.idleTimerCallback = function (self) {
            self.callback(self);
            self.callbackTimer = self.timer.setInterval(self.callback, self.callbackDelay, self);
        };
        IdleCallbackTimer.prototype.addCallback = function (fn) {
            this.removeCallback(fn);
            this.callbacks.push(fn);
        };
        IdleCallbackTimer.prototype.removeCallback = function (fn) {
        ...
        IdleCallbackTimer.prototype.callback = function (self) {
            for (var i = 0; i < self.callbacks.length; i++) {
                self.callbacks[i]();
            }
        };
        return IdleCallbackTimer;
    })();
    powerbi.IdleCallbackTimer = IdleCallbackTimer;
})(powerbi || (powerbi = {}));
//-----------------------------------------------------------------------
// <copyright company="Microsoft Corporation">
//        Copyright (c) Microsoft Corporation.  All rights reserved.
...
(function (powerbi) {
    ...
    var LocalyticsService = (function () {
        ...
        */
        function LocalyticsService(localyticsAppKey, idleTimer, localyticsSdk, documentReplacment) {
            var self = this;
        ...
        LocalyticsService.prototype.initialize = function (hostData) {
            this.hostData = hostData;
            var self = this;
            ...
            self.executeOrQueue(self, function () {
                ...
                var hashedUserId = powerbi.getHashCode(hostData.userId);
        ...
        LocalyticsService.prototype.getCookieString = function (url, key, value) {
            var domainMatch = url.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i);
            var domain = domainMatch ? domainMatch[0] : '';
            var cookieText = key + '=' + value + ';' + 'domain=.' + domain + ';' + 'max-age=max-age-in-seconds=2592000';
            return cookieText;
        };
        /** Log telemetry event **/
        LocalyticsService.prototype.logEvent = function (eventData) {
            ...
            var properties = $.extend({}, eventData.getFormattedInfoObject(), {
                ...
                hashedUuid: powerbi.getHashCode(hostData.userId),
        ...
        /** Starts receording a timed event **/
        LocalyticsService.prototype.startTimedEvent = function (eventData) {
        };
        /** Log a timed event **/
        LocalyticsService.prototype.endTimedEvent = function (eventData) {
            var self = this;
            var hostData = this.hostData;
            var properties = $.extend({}, eventData.getFormattedInfoObject(), {
        ...
        LocalyticsService.prototype.executeOrQueue = function (self, fn) {
            if (self.idleTimer) {
        ...
        LocalyticsService.namespace = 'PowerBI';
        // The localytics cookie is '__ll_' + namespace + '_iu'
        LocalyticsService.localyticsUserIdCookie = '__ll_PowerBI_iu';
        LocalyticsService.localyticsSessionIdCookie = '__ll_PowerBI_csu';
...
(function (powerbi) {
    var LoggerServiceWrapper = (function () {
        ...
        LoggerServiceWrapper.prototype.initialize = function (hostData) {
            this.loggerService.initialize(hostData);
        };
...
(function (powerbi) {
    ...
    (function (telemetry) {
        function createTelemetryHostService() {
            return new TelemetryHostService(powerbi.telemetrySamplingRules, powerbi.session.userInfo, powerbi.build, clusterUri, powerbi.telemetryConstants.pbiClientName, telemetrySessionId);
        }
        telemetry.createTelemetryHostService = createTelemetryHostService;
        var TelemetryHostService = (function () {
            // TODO: make telemetrySamplesRates to be strong typed
            function TelemetryHostService(telemetrySamplesRates, userInfo, build, cluster, clientName, sessionId) {
            ...
            TelemetryHostService.prototype.getLoggerServices = function () {
                return this.loggers;
            };
            TelemetryHostService.prototype.getHostData = function () {
                return this.hostData;
            };
            return TelemetryHostService;
        })();
        var TelemetryConfigurations = (function () {
            function TelemetryConfigurations() {
            }
            TelemetryConfigurations.getDefaultLoggingCollection = function (telemetrySamplingRates) {
            ...
            TelemetryConfigurations.getLoggingCollection = function (telemetrySamplingRates) {
                ...
                var idleTimer = new powerbi.IdleCallbackTimer(TelemetryConfigurations.timeBeforeBrowserConsideredIdleInMs, TelemetryConfigurations.timeBetweenUploadsInMs);
                if (telemetrySamplingRates) {
                    if (telemetrySamplingRates.perf)
                        loggingServices.push(this.wrapLogger(telemetrySamplingRates.perf, new powerbi.AutoEndingWrapper(new powerbi.EtwPerfLoggerService())));
                    if (telemetrySamplingRates.appInsights) {
                        loggingServices.push(this.wrapLogger(telemetrySamplingRates.appInsights, new powerbi.AppInsightsV2Service(appInsights)));
                    }
                    if (telemetrySamplingRates.localytics)
                        loggingServices.push(this.wrapLogger(telemetrySamplingRates.localytics, new powerbi.LocalyticsService(lKey, idleTimer)));
                }
            ...
            TelemetryConfigurations.getStandardCollectionRules = function () {
                ...
                var lKey = (typeof (localyticsInstrKey) !== 'undefined') ? localyticsInstrKey : '';
                var idleTimer = new powerbi.IdleCallbackTimer(TelemetryConfigurations.timeBeforeBrowserConsideredIdleInMs, TelemetryConfigurations.timeBetweenUploadsInMs);
                loggingServices.push(this.wrapLogger(TelemetryConfigurations.EtwStandardLoggerConfig, new powerbi.AutoEndingWrapper(new powerbi.EtwPerfLoggerService())));
                loggingServices.push(this.wrapLogger(TelemetryConfigurations.AppInsightStandardLoggerConfig, new powerbi.AppInsightsV2Service(appInsights)));
                loggingServices.push(this.wrapLogger(TelemetryConfigurations.LocalyticsStandardLoggerConfig, new powerbi.LocalyticsService(lKey || "", idleTimer)));
                return loggingServices;
            };
            ...
            TelemetryConfigurations.wrapLogger = function (samplingRates, service) {
                var transmissionRule = samplingRates ? new powerbi.LoggerServiceRule(samplingRates) : new powerbi.SendNothingRule();
                var transmissionControllerLoggingService = new powerbi.LoggerServiceWrapper(service, transmissionRule);
                return transmissionControllerLoggingService;
            };
            TelemetryConfigurations.timeBetweenUploadsInMs = 250;
            TelemetryConfigurations.timeBeforeBrowserConsideredIdleInMs = 1000;
...
(function (powerbi) {
    var SendAllRule = (function () {
        ...
        SendAllRule.prototype.shoudLog = function (event, loggerServiceId) {
            return true;
        };
        return SendAllRule;
    })();
    ...
    var SendNothingRule = (function () {
        ...
        SendNothingRule.prototype.shoudLog = function (event, loggerServiceId) {
            return false;
        };
        return SendNothingRule;
    })();
    ...
    var LoggerServiceRule = (function () {
        ...
        LoggerServiceRule.prototype.shoudLog = function (event, loggerType) {
            var loggers = event.loggers;
            if (loggers)
                return (loggers & loggerType) === loggerType;
            var use = event.category ? powerbi.TelemetryCategory[event.category] : powerbi.TelemetryCategory[0 /* Verbose */];
            if (this.shouldLogMap[use] !== undefined)
                return this.shouldLogMap[use];
            return false;
        };
        return LoggerServiceRule;
    })();
    ...
    (function (session) {
        ...
        var UserInfoUtils = (function () {
            ...
            UserInfoUtils.getEmailAddressForReceivingMail = function () {
                ...
                return jsCommon.StringExtensions.isNullOrEmpty(userInfo.alternateEmail) ? userInfo.name : userInfo.alternateEmail;
            };
