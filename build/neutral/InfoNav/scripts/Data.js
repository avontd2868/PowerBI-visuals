...
(function (powerbi) {
    ...
    (function (labelPosition) {
        ...
        labelPosition.topCenter = 'TopCenter';
        labelPosition.topRight = 'TopRight';
        labelPosition.middleLeft = 'MiddleLeft';
        labelPosition.middleCenter = 'MiddleCenter';
        labelPosition.middleRight = 'MiddleRight';
        labelPosition.bottomLeft = 'BottomLeft';
        labelPosition.bottomCenter = 'BottomCenter';
        ...
        labelPosition.outsideBase = 'OutsideBase';
        labelPosition.outsideEnd = 'OutsideEnd';
        function members() {
            return [
                { value: labelPosition.topLeft, displayName: function (resources) { return resources.get('Visual_LabelPosition_TopLeft'); } },
                { value: labelPosition.topCenter, displayName: function (resources) { return resources.get('Visual_LabelPosition_TopCenter'); } },
                { value: labelPosition.topRight, displayName: function (resources) { return resources.get('Visual_LabelPosition_TopRight'); } },
                { value: labelPosition.middleLeft, displayName: function (resources) { return resources.get('Visual_LabelPosition_MiddleLeft'); } },
                { value: labelPosition.middleCenter, displayName: function (resources) { return resources.get('Visual_LabelPosition_MiddleCenter'); } },
                { value: labelPosition.middleRight, displayName: function (resources) { return resources.get('Visual_LabelPosition_MiddleRight'); } },
                { value: labelPosition.bottomLeft, displayName: function (resources) { return resources.get('Visual_LabelPosition_BottomLeft'); } },
                { value: labelPosition.bottomCenter, displayName: function (resources) { return resources.get('Visual_LabelPosition_BottomCenter'); } },
                { value: labelPosition.bottomRight, displayName: function (resources) { return resources.get('Visual_LabelPosition_BottomRight'); } },
                ...
                { value: labelPosition.outsideBase, displayName: function (resources) { return resources.get('Visual_LabelPosition_OutsideBase'); } },
...
(function (powerbi) {
    ...
    (function (data) {
        ...
        (function (bingNews) {
            ...
            var BingNewsDataProvider = (function () {
                function BingNewsDataProvider(host, httpService) {
                    this.cachedResults = {};
                ...
                BingNewsDataProvider.prototype.execute = function (options) {
                    var searchKey = options.command.searchKey;
                    if (!searchKey)
                        return;
                    ...
                    if (options.allowCache && searchKey in cachedResults) {
                        ...
                        this.httpService.get('https://api.datamarket.azure.com/Bing/Search/News?$format=json&NewsSortBy=%27Date%27&Query=%27' + encodeURIComponent(searchKey) + '%27', {
                        ...
                        }, function (response) { return deferred.reject(); });
                    }
                    return powerbi.RejectablePromise(deferred);
                };
                return BingNewsDataProvider;
            })();
            bingNews.BingNewsDataProvider = BingNewsDataProvider;
        })(bingNews = data.bingNews || (data.bingNews = {}));
    })(data = powerbi.data || (powerbi.data = {}));
})(powerbi || (powerbi = {}));
//-----------------------------------------------------------------------
// <copyright company="Microsoft Corporation">
            ...
            function matchesKeys(selector, keysList) {
                ...
                for (var i = 0; i < selectorDataLength; i++) {
                    ...
                    if (!selectorDataExprs)
                        continue;
                    if (!_data.SQExprUtil.sequenceEqual(keysList[i], selectorDataExprs))
                        return false;
                }
                return true;
            }
...
(function (powerbi) {
    ...
    (function (DataViewObjects) {
        ...
        function getValue(objects, propertyId, defaultValue) {
            ...
            return object[propertyId.propertyName];
        }
    ...
    (function (data) {
        ...
        (function (DataViewSelfCrossJoin) {
            ...
            function applyCategorical(dataViewMetadata, dataViewCategorical) {
                ...
                var category = dataViewCategorical.categories[0], categoryValues = category.values, categoryIdentities = category.identity, categoryLength = categoryIdentities.length, crossJoinedValuesArray = [], nullValuesArray = createNullValues(categoryLength);
    ...
    (function (data) {
        ...
        (function (DataViewScopeWildcard) {
            function matches(wildcard, instance) {
                ...
                if (!instanceExprs)
                    return false;
                return data.SQExprUtil.sequenceEqual(wildcard.exprs, instanceExprs);
            }
        ...
        (function (DataViewTransform) {
            ...
            */
            ...
            function findSelectorForRuleInput(dataView, selectorRoles) {
                ...
                if (!categories || categories.length !== 1)
                    return;
                var categoryColumn = categories[0], categoryRoles = categoryColumn.source.roles;
                if (!categoryRoles || !categoryRoles[selectorRoles[0]])
                    return;
                return { data: [data.DataViewScopeWildcard.fromExprs(categoryColumn.identityFields)] };
            }
...
(function (powerbi) {
    var DsrClientError = (function () {
        ...
        DsrClientError.prototype.getDetails = function (resourceProvider) {
            ...
            var additionalInfo = DsrClientError.isCodeKnown(this.code) || !azureDetails ? [{ errorInfoKey: key, errorInfoValue: val, },] : [];
            if (azureDetails) {
                // If there is already some data to display, then use 'More Info' as
                // the key.
                var detailsKey = additionalInfo.length === 0 ? key : resourceProvider.get('DsrError_MoreInfo');
                additionalInfo.push({
        ...
        DsrClientError.prototype.getErrorKeyValueFromStatusCode = function (code, resourceProvider) {
        ...
        (function (dsr) {
            ...
            var ExecuteSemanticQueryBatcher = (function () {
                ...
                */
                    ...
                    for (var i = 0, ilen = queries.length; i < ilen; ++i) {
                        ...
                        if (!query.execution.rejected()) {
                            ...
                            if (dataSourceGroup) {
                                ...
                                var newDataSourceGroup = { dataSource: query.options.dataSource, queuedExecutions: [query] };
                ...
                ExecuteSemanticQueryBatcher.prototype.findDataSourceGroup = function (dataSource, dataSourceGroups) {
    ...
    (function (_data) {
        ...
        (function (dsr) {
            ...
            var ExecuteSemanticQueryProxy = (function () {
                ...
                */
                ...
                ExecuteSemanticQueryProxy.prototype.executeBatch = function (batch) {
                    ...
                    this.communication.execute(batch.commands, batch.dataSource).then(function (result) { return _this.onSuccess(result, promises, schemaName); }, function (result) { return _this.onError(promises); });
                };
            ...
            var ExecuteSemanticQueryProxyHttpCommunication = (function () {
                ...
                ExecuteSemanticQueryProxyHttpCommunication.prototype.execute = function (commands, dataSource) {
...
(function (powerbi) {
    ...
    (function (data) {
        ...
        (function (SQExprValidationError) {
            SQExprValidationError[SQExprValidationError["invalidSchemaReference"] = 0] = "invalidSchemaReference";
            SQExprValidationError[SQExprValidationError["invalidEntityReference"] = 1] = "invalidEntityReference";
            SQExprValidationError[SQExprValidationError["invalidColumnReference"] = 2] = "invalidColumnReference";
            SQExprValidationError[SQExprValidationError["invalidMeasureReference"] = 3] = "invalidMeasureReference";
            SQExprValidationError[SQExprValidationError["invalidLeftOperandType"] = 4] = "invalidLeftOperandType";
            SQExprValidationError[SQExprValidationError["invalidRightOperandType"] = 5] = "invalidRightOperandType";
        ...
        var SQExprValidationVisitor = (function (_super) {
                ...
                if (fieldDef) {
                    ...
                    if (entity) {
                        ...
                        if (!prop || prop.kind !== 0 /* Column */)
                            this.register(2 /* invalidColumnReference */);
                    }
                }
                return expr;
            };
                ...
                if (fieldDef) {
                    ...
                    if (entity) {
                        ...
                        if (!prop || prop.kind !== 1 /* Measure */)
                            this.register(3 /* invalidMeasureReference */);
                    }
                }
                return expr;
            };
            ...
            SQExprValidationVisitor.prototype.visitContains = function (expr) {
                ...
                if (!(left instanceof SQColumnRefExpr))
                    this.register(4 /* invalidLeftOperandType */);
                else if (!(right instanceof SQConstantExpr) || !right.type.text)
                    this.register(5 /* invalidRightOperandType */);
                return expr;
            };
            ...
            SQExprValidationVisitor.prototype.validateEntity = function (schemaName, entityName) {
                ...
                if (schema) {
                    ...
                    if (entity)
                        return entity;
                    this.register(1 /* invalidEntityReference */);
                }
                else {
                    this.register(0 /* invalidSchemaReference */);
                }
            };
    ...
    (function (data) {
        ...
        var SemanticQuery = (function () {
            ...
            SemanticQuery.prototype.selectNameOf = function (expr) {
                var index = SQExprUtil.indexOfExpr(this.selectItems.map(function (s) { return s.expr; }), expr);
                if (index >= 0)
        ...
        (function (SQExprUtil) {
            ...
            SQExprUtil.indexOfExpr = indexOfExpr;
            ...
            SQExprUtil.sequenceEqual = sequenceEqual;
        })(SQExprUtil = data.SQExprUtil || (data.SQExprUtil = {}));
        var SemanticQueryUtil;
        (function (SemanticQueryUtil) {
            function uniqueName(namedItems) {
            ...
            SemanticQueryUtil.uniqueName = uniqueName;
        })(SemanticQueryUtil || (SemanticQueryUtil = {}));
        ...
        var DataProviderWrapper = (function () {
            ...
            DataProviderWrapper.prototype.execute = function (options) {
                ...
                if (provider.execute) {
                    ...
                    dataViewDeferred.promise.catch(function () { return providerExecution.reject(new powerbi.UnknownClientError()); });
                    providerExecution.then(function (data) {
                        if (data) {
                            ...
                            dataViewDeferred.reject(new powerbi.UnknownClientError());
                        }
                    }, function (error) {
                    ...
                    promise.catch(function (error) { return providerExecution.reject(error || new powerbi.UnknownClientError()); });
                    return promise;
                }
                else {
                    // (2)
            ...
            (function (SemanticQuerySerializer) {
                ...
                (function (Deserializer) {
                    ...
                    function select(contract, selectNames, from) {
                        debug.assertValue(contract, 'contract');
                        debug.assertValue(from, 'from');
                        var name = contract.Name || StringExtensions.findUniqueName(selectNames, 'select');
                        selectNames[name] = true;
                        return {
                            name: name,
                            expr: ExprBuilder.create(contract, from)
                        };
                    }
