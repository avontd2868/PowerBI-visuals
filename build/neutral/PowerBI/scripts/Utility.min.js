...
!function(a) {
    ...
    var d = function() {
        ...
        return b.prototype.startSession = function() {
            ...
            h ? d.push(h) : d.push(this.root.id);
            var m = {
                info: {}
            };
...
!function(a) {
    ...
    var c = function() {
        ...
        }, b.prototype.startTimedEvent = function(a) {}, b.prototype.endTimedEvent = function(a) {
            var b = $.extend({}, this.hostData, a.getFormattedInfoObject(), {
                id: a.id,
                start: new Date(a.time).toISOString(),
...
!function(a) {
    var b = function() {
        ...
        return a.prototype.initialize = function(a) {
            ...
            return 8;
        }, a.prototype.logEvent = function(a) {}, a.prototype.startTimedEvent = function(a) {
...
!function(a) {
    ...
    var b = function() {
        ...
        }, b.prototype.startTimedEvent = function(a) {}, b.prototype.endTimedEvent = function(b) {
            var c = this, d = this.hostData, e = $.extend({}, b.getFormattedInfoObject(), {
...
!function(a) {
    var b = function() {
        function a() {}
        return a.prototype.shoudLog = function(a, b) {
            return !0;
        }, a;
    }();
    a.SendAllRule = b;
