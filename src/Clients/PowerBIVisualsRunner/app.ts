...
module powerbi.visuals.runner {
    ...
    export class VisualsRunner {
        ...
        private hostServices = null; //powerbi.createVisualHostServices();
        ...
        private onVisualTypeSelection(value: string): void {
            ...
            }, powerbi.data.dsr.createExecuteSemanticQueryProxyHttpCommunication(this.httpService))
                .transform(JSON.parse(jsCommon.GzipUtility
                .uncompress(this.dataSet.data)));
        ...
        public render(plugin, dataProvider): void {
            ...
            var transformActions = DataViewTransform.createTransformActions(
                this.dataSet.config.visual.queryMetadata,
                this.dataSet.config.visual.elements,
                plugin.capabilities.objects,
                null);

            var dataViews: DataView[] = DataViewTransform.apply({
