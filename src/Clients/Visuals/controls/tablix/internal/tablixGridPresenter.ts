...
module powerbi.visuals.controls.internal {
    ...
    export class TablixRowPresenter {
        ...
        public initialize(owner: TablixRow) {
            this._owner = owner;
        }

        public createCellPresenter(): TablixCellPresenter {
            return new TablixCellPresenter(this._fitProportionally);
        }
        ...
        public getHeight(): number {
            return this.getCellHeight(this._owner.getTablixCell());
        }
    ...
    export class TablixColumnPresenter {
        private _owner: TablixColumn;

        public initialize(owner: TablixColumn) {
            this._owner = owner;
        }

        public getWidth(): number {
            return this.getCellWidth(this._owner.getTablixCell());
        }
    ...
    export class TablixGridPresenter {
        ...
        public createRowPresenter(): TablixRowPresenter {
            return new TablixRowPresenter(this._owner.fillColumnsProportionally);
        }

        public createColumnPresenter(): TablixColumnPresenter {
            return new TablixColumnPresenter();
        }
