...
module powerbi.visuals {
    ...
    export module ColumnUtil {
        ...
        export function drawDefaultShapes(data: ColumnChartData, series: D3.UpdateSelection, layout: IColumnLayout, itemCS: ClassAndSelector): D3.UpdateSelection {
        ...
        export function drawDefaultLabels(series: D3.UpdateSelection, layout: ILabelLayout, viewPort: IViewport): void {
            if (series && series.data().length > 0) {
                ...
                dataLabelUtils.drawDefaultLabelsForDataPointChart(dataPoints, series, layout, viewPort);
            }
        }
    }
    ...
    export module StackedUtil {
        ...
        export function createValueFormatter(valuesMetadata: DataViewMetadataColumn[], is100Pct: boolean, interval: number): IValueFormatter {
            ...
            if (is100Pct)
                return valueFormatter.create({ format: constants.percentFormat, value: interval, value2: /* temporary workaround */ 0 });

            // Default to apply formatting from the first measure.
            return valueFormatter.create({ format: valueFormatter.getFormatString(valuesMetadata[0], columnChartProps.general.formatString), value: interval, value2: /* temporary workaround */ 0 });
        }
    ...
    export class DataWrapper {
        ...
        public constructor(columnChartData: ColumnChartData, isScalar: boolean) {
