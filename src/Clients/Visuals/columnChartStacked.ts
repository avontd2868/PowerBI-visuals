...
module powerbi.visuals {
    ...
    export class StackedColumnChartStrategy implements IColumnChartStrategy {
        ...
        public setupVisualProps(columnChartProps: ColumnChartContext): void {
            ...
            var margin = this.margin = columnChartProps.margin;
        ...
        public drawColumns(useAnimation: boolean): D3.Selection {
            ...
            if (dataLabelSettings != null) {
                dataLabelLayout = dataLabelUtils.getColumnChartLabelLayout(data, this.getLabelLayoutXY(axisOptions), true, this.graphicsContext.is100Pct);
            }
            ...
            if (!this.animator || !useAnimation || result.failed) {
                shapes = ColumnUtil.drawDefaultShapes(data, series, stackedColumnLayout, StackedColumnChartStrategy.classes.item);
                if (dataLabelLayout !== null) {
                    if (dataLabelSettings.show) {
                        ColumnUtil.drawDefaultLabels(series, dataLabelLayout, { height: this.height, width: this.width });
                }
                    else {
        ...
        private getLabelLayoutXY(axisOptions: ColumnAxisOptions): any {
            var columnWidth = axisOptions.columnWidth;
            ...
            return {
                    ...
                    y: (d: ColumnChartDataPoint) => scaledY0 + AxisHelper.diffScaled(yScale, d.position, 0) - dataLabelUtils.defaultColumnLabelMargin
            };
        }
    }
    ...
    export class StackedBarChartStrategy implements IColumnChartStrategy {
        ...
        public setupVisualProps(barChartProps: ColumnChartContext): void {
            ...
            var margin = this.margin = barChartProps.margin;
            this.width = this.graphicsContext.width;
            this.height = this.graphicsContext.height;
        ...
        public drawColumns(useAnimation: boolean): D3.Selection {
            ...
            var dataLabelLayout = null;
            if (dataLabelSettings != null) {
                dataLabelLayout = dataLabelUtils.getColumnChartLabelLayout(data, this.getLabelLayoutXY(axisOptions), false, this.graphicsContext.is100Pct);
            }
            ...
            if (!this.animator || !useAnimation || result.failed) {
                shapes = ColumnUtil.drawDefaultShapes(data, series, stackedBarLayout, StackedBarChartStrategy.classes.item);
                if (dataLabelLayout !== null) {
                    if (dataLabelSettings.show) {
                        ColumnUtil.drawDefaultLabels(series, dataLabelLayout, { height: this.height, width: this.width });
                }
        ...
        private getLabelLayoutXY(axisOptions: ColumnAxisOptions): any {
            ...
            return {
                x: (d: ColumnChartDataPoint) => scaledX0 + Math.abs(AxisHelper.diffScaled(xScale, 0, d.originalValue)) + AxisHelper.diffScaled(xScale, d.position - d.valueAbsolute, 0) + dataLabelUtils.defaultColumnLabelMargin,
