...
module powerbi.visuals {
    ...
    export class Treemap implements IVisual, IInteractiveVisual {
            ...
            if (dataView && dataView.categorical && dataView.categorical.values) {
                ...
                if ((data.categories == null) && values) {
                    ...
                    for (var i = 0, ilen = values[0].length; i < ilen; i++) {
                        ...
                        var objects = valueColumn.objects && valueColumn.objects[0];
                    ...
                    for (var i = 0, ilen = values.length; i < ilen; i++) {
                        ...
                        var categoryValue = categoryColumn.values[i];
        ...
        public update(options: VisualUpdateOptions) {
            ...
            this.updateInternal(true /*useAnimation*/, options.duration);
        }
        ...
        public onResizing(viewport: IViewport, duration: number): void {
            ...
            this.updateInternal(false /*useAnimation*/, duration || 0);
        }
        ...
        private initViewportDependantProperties(duration: number = 0): void {
            ...
            var viewport: IViewport = {
                height: this.parentViewport.height - legendMargins.height,
                width: this.parentViewport.width - legendMargins.width
            };
        ...
        private updateInternal(useAnimation: boolean = true, duration: number = 0): void {
            ...
            TooltipManager.addTooltip(shapes, (d, i) => { return d.tooltipInfo; });
            TooltipManager.addTooltip(highlightShapes, (d, i) => d.highlightedTooltipInfo);
