...
module powerbitests {
    ...
    import Table = powerbi.visuals.TableNew;
    ...
    describe('Table logic', () => {
        ...
        it('loadMoreData calls control refresh', () => {
            var nav = { update() { } };
            var control = { refresh() { }, rowDimension: {} };
        ...
        it('bindRowHeader callback', () => {
            ...
            var binderOptions = { onBindRowHeader: (item: any) => { callBackCalled = true; } };
    ...
    describe('Table DOM validation', () => {
        ...
        function addNoMarginClass(expectedValues: string[][]): void {
