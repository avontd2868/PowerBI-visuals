...
(function (powerbitests) {
    ...
    function scatterChartDomValidation(interactiveChart) {
        ...
        var dataViewMetadataFourColumn = {
            columns: [
                { name: 'col1', roles: { "Category": true }, type: DataShapeUtility.describeDataType(2048 /* String */) },
                { name: 'col2', isMeasure: true, roles: { "X": true }, type: DataShapeUtility.describeDataType(1 /* Number */) },
                { name: 'col3', isMeasure: true, roles: { "Y": true }, type: DataShapeUtility.describeDataType(1 /* Number */) },
                { name: 'col4', isMeasure: true, roles: { "Size": true }, type: DataShapeUtility.describeDataType(1 /* Number */) }
            ]
        };
        var dataViewMetadata = {
            columns: [
        ...
        it('scatter chart single category value dom validation', function (done) {
            var metadata = {
                columns: [
                    { name: 'col1', type: DataShapeUtility.describeDataType(2048 /* String */) },
                    { name: 'col2', isMeasure: true, roles: { "X": true }, type: DataShapeUtility.describeDataType(1 /* Number */) },
                    { name: 'col3', isMeasure: true, roles: { "Size": true }, type: DataShapeUtility.describeDataType(1 /* Number */) },
                    { name: 'col4', isMeasure: true, roles: { "Y": true }, type: DataShapeUtility.describeDataType(1 /* Number */) }
                ]
            };
            v.onDataChanged({
                dataViews: [{
        ...
        it('scatter chart axis labels dom validation', function (done) {
            var metadata = {
                columns: [
                    { name: 'col1' },
                    { name: 'X-Axis', isMeasure: true, roles: { "X": true }, type: DataShapeUtility.describeDataType(1 /* Number */) },
                    { name: 'Size', isMeasure: true, roles: { "Size": true }, type: DataShapeUtility.describeDataType(1 /* Number */) },
                    { name: 'Y-Axis', isMeasure: true, roles: { "Y": true }, type: DataShapeUtility.describeDataType(1 /* Number */) }
                ]
            };
            var categoryIdentities = [
                powerbitests.mocks.dataViewScopeIdentity('a'),
    ...
    describe("scatterChart converter validation", function () {
        it('scatter chart dataView with role validation', function () {
            ...
            expect(scatterChartData.legendData.dataPoints.map(function (l) { return l.label; })).toEqual(['a', 'b', 'c', 'd', 'e']);
        ...
        it('scatter chart dataView without role validation', function () {
            ...
            expect(dataPoints[0].fill).not.toBe(dataPoints[1].fill);
            var legendItems = scatterChartData.legendData.dataPoints;
            expect(legendItems.map(function (l) { return l.label; })).toEqual(['a', 'b', 'c', 'd', 'e']);
            var legendColors = legendItems.map(function (l) { return l.color; });
            expect(legendColors).toEqual(ArrayExtensions.distinct(legendColors));
            //Tooltips
    ...
    describe('scatterChart interactivity', function () {
        ...
        it('scatter chart clear on background click', function (done) {
            var dimmedOpacity = ScatterChart.DimmedBubbleOpacity.toString();
            var defaultOpacity = ScatterChart.DefaultBubbleOpacity.toString();
            var identities = [
                powerbitests.mocks.dataViewScopeIdentity('a'),
    ...
    describe("scatterChart axis label exitance validation", function () {
        it('scatter chart axis labels existance dom validation with viewport height greater than axisLabelVisibleMinHeight non-interactive', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height greater than axisLabelVisibleMinHeight interactive', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height smaller than axisLabelVisibleMinHeight non-interactive', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height smaller than axisLabelVisibleMinHeight interactive', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height smaller than axisLabelVisibleMinHeight non-interactive mobile', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height greater than axisLabelVisibleMinHeight non-interactive mobile', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height smaller than axisLabelVisibleMinHeight interactive mobile', function (done) {
        ...
        it('scatter chart axis labels existance dom validation with viewport height greater than axisLabelVisibleMinHeight interactive mobile', function (done) {
    ...
    describe("scatterChart legends exitance validation", function () {
        ...
        it('scatter chart legends existance dom validation with viewport height smaller than legendVisibleMinHeight non-interactive mobile', function (done) {
    ...
    function testAxisAndLegendExistance(domSizeHeightString, domSizeWidthString, isInteractive, isMobile) {
